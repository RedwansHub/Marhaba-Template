...
import sideImage2 from '../public/image4.jpg'
import Link from 'next/link'

const Main = () => {
  return (
    <div id='gallery' className='max-w-[1380px] mx-auto ' >
        <div className='m-10 max-w-md mx-auto overflow-hidden md:max-w-7xl'>
          <div className='md:flex'>
            <div className='md:w-1/2 w-full '>
              <Image src={sideImage} width={725} height={450} className='object-cover h-full w-full' alt=''/>
